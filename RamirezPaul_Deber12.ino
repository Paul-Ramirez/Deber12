 ...
 * fecha:25/01/2021
 */
//bsaes de datos de sensores y prueba
...
void setup() {
  ...
  for (int j = 0; j < 20; j++) {//recorrer matriz prueba
    ...
    { // condicion para seleccionar el grupo al q pertenece
      Serial.println("Punto perteneciente al grupo1");// para que sea del grupo 1 la suma no tiene que dar valores mayores a 4
      distMen = 2500;
    }
    else
    { // por lo tanto si el resultado de k es menor a 4 al punto se le asigna al primer grupo
      Serial.println("Punto perteneciente al grupo 2");
